...
LOCAL unsigned short wCortexPort = 1026; // Cortex is listening at this port
LOCAL unsigned short wMultiCastPort = 1025; // Cortex sends frames to this port and associated address
